...
*
* @package language
* @version $Id: info_acp_thanks.php 127 2010-04-17 10:02:51Палыч $
...
$lang = array_merge($lang, array(
	...
	'ACP_THANKS_REPUT_SETTINGS_EXPLAIN'	=> 'Здесь вы можете установить значения настроек рейтинга для сообщений, тем и форумов, основанной на системе Спасибо. <br /> Объект (сообщение, тема или форум), имеющий наибольшее суммарное число благодарностей, принимается за 100% рейтинга.',
	...
	'THANKS_ONLY_FIRST_POST_EXPLAIN'	=> 'Если включено, вы можете объявить благодарность только за первое сообщение в теме',
	...
	'THANKS_REFRESH_EXPLAIN'			=> 'Обновление счётчиков благодарностей после массового удаления постов/тем/пользователей',
	...
	'THANKS_REPUT_IMAGE_DEFAULT'		=> 'Примеры графичеcких изображений',
	...
	'THANKS_TOP_NUMBER_EXPLAIN'			=> 'Укажите число пользователей для вывода в топлисте',
