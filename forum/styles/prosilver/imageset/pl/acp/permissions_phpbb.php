...
*
* @package language
* @version $Id: permissions_phpbb.php 8911.2 2009-03-23 Ronnie $
...
$lang = array_merge($lang, array(
	'permission_cat'	=> array(
		...
		'profile'		=> 'Profil',
		'settings'		=> 'Ustawienia',
		'topic_actions'	=> 'Akcje na tematach',
...
$lang = array_merge($lang, array(
	...
	'acl_u_pm_smilies'	=> array('lang' => 'Może dodawać uśmieszki do prywatnych wiadomości', 'cat' => 'pm'),
	'acl_u_pm_img'		=> array('lang' => 'Może dodawać obrazki do prywatnych wiadomości', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'Może dodawać animacje Flash do prywatnych wiadomości', 'cat' => 'pm'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_post'		=> array('lang' => 'Może rozpoczynać nowe tematy', 'cat' => 'post'),
	'acl_f_reply'		=> array('lang' => 'Może odpowiadać w istniejących tematach', 'cat' => 'post'),
	'acl_f_icons'		=> array('lang' => 'Może używać ikon postów', 'cat' => 'post'),
	'acl_f_announce'	=> array('lang' => 'Może tworzyć ogłoszenia', 'cat' => 'post'),
	'acl_f_sticky'		=> array('lang' => 'Może przyklejać tematy', 'cat' => 'post'),
	...
	'acl_f_smilies'		=> array('lang' => 'Może dodawać uśmieszki', 'cat' => 'content'),
	'acl_f_img'			=> array('lang' => 'Może dodawać obrazki', 'cat' => 'content'),
	'acl_f_flash'		=> array('lang' => 'Może dodawać animacje Flash', 'cat' => 'content'),

	'acl_f_edit'		=> array('lang' => 'Może edytować swoje posty', 'cat' => 'actions'),
	'acl_f_delete'		=> array('lang' => 'Może usuwać swoje posty', 'cat' => 'actions'),
	'acl_f_user_lock'	=> array('lang' => 'Może blokować swoje tematy', 'cat' => 'actions'),
	'acl_f_bump'		=> array('lang' => 'Może przesuwać tematy w górę', 'cat' => 'actions'),
	'acl_f_report'		=> array('lang' => 'Może zgłaszać posty', 'cat' => 'actions'),
	'acl_f_subscribe'	=> array('lang' => 'Może obserwować dział', 'cat' => 'actions'),
	'acl_f_print'		=> array('lang' => 'Może drukować tematy', 'cat' => 'actions'),
	'acl_f_email'		=> array('lang' => 'Może wysyłać e-mailem tematy', 'cat' => 'actions'),
...
$lang = array_merge($lang, array(
	...
	'acl_m_move'	=> array('lang' => 'Może przenosić tematy', 'cat' => 'topic_actions'),
	'acl_m_lock'	=> array('lang' => 'Może blokować tematy', 'cat' => 'topic_actions'),
	'acl_m_split'	=> array('lang' => 'Może dzielić tematy', 'cat' => 'topic_actions'),
	'acl_m_merge'	=> array('lang' => 'Może łączyć tematy', 'cat' => 'topic_actions'),
