...
*
* @package language
* @version $Id: forums.php 9309 2009-05-10 LEW21 $
...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_DAYS_EXPLAIN'	=> 'Liczba dni od napisania ostatniego postu w temacie, po jakiej temat jest usuwany.',
	'AUTO_PRUNE_FREQ'			=> 'Częstotliwość czyszczenia',
	'AUTO_PRUNE_FREQ_EXPLAIN'	=> 'Liczba dni między kolejnymi czyszczeniami.',
	'AUTO_PRUNE_VIEWED'			=> 'Czas od ostatniego zobaczenia tematu',
	'AUTO_PRUNE_VIEWED_EXPLAIN'	=> 'Liczba dni od ostatniego zobaczenia tematu, po jakiej temat jest usuwany.',
	...
	'DISPLAY_ACTIVE_TOPICS_EXPLAIN'		=> 'Jeśli włączone, aktywne tematy w wybranych poddziałach będą wyświetlane pod listą poddziałów przy wyświetlaniu zawartości kategorii.',
	...
	'ENABLE_POST_REVIEW_EXPLAIN'	=> 'Jeśli włączone, użytkownik może przejrzeć jeszcze raz swój post, jeśli w temacie został(y) napisany(e) nowy(e) post(y), podczas, gdy on pisał swój post. Opcja ta powinna zostać wyłączona dla działów gawędziarskich.',
	'ENABLE_RECENT'					=> 'Włącz aktywne tematy',
	'ENABLE_RECENT_EXPLAIN'			=> 'Jeśli włączone, tematy napisane w tym dziale będą wyświetlane na liście aktywnych tematów.',
	'ENABLE_TOPIC_ICONS'			=> 'Włącz ikony postów i tematów',

	'FORUM_ADMIN'						=> 'Zarządzanie działami',
	'FORUM_ADMIN_EXPLAIN'				=> 'W phpBB3 nie ma kategorii w rozumieniu z phpBB2, wszystko jest oparte na działach. Każdy dział może mieć dowolną liczbę poddziałów i możesz wybrać czy ma być możliwość pisania w nim, czy nie (tzn. czy ma zachowywać się jak kategoria z phpBB2). Tutaj możesz dodawać, edytować, usuwać, blokować i odblokowywać pojedyncze działy oraz zmieniać ich ustawienia. Jeśli tematy i posty w nich uległy desynchronizacji, możesz też ponownie zsynchronizować dział. <br /><strong>Aby nowoutworzone działy były wyświetlane, musisz skopiować albo ustawić uprawnienia dostępu do nich!</strong>',
	'FORUM_AUTO_PRUNE'					=> 'Włącz automatyczne oczyszczanie',
	'FORUM_AUTO_PRUNE_EXPLAIN'			=> 'Oczyszcza dział z tematów, ustaw, na jakich zasadach to robić poniżej.',
	...
	'FORUM_DELETE_EXPLAIN'				=> 'Za pomocą poniższego formularza możesz usunąć dział. Jeśli można w nim pisać, możesz też wybrać gdzie umieścić wszystkie tematy (lub poddziały), które zawiera.',
	...
	'PRUNE_OLD_POLLS_EXPLAIN'	=> 'Usuwa również tematy z ankietami.',

	'REDIRECT_ACL'	=> 'Teraz możesz %sustawić uprawnienia dostępu do tego działu%s.',

	'SYNC_IN_PROGRESS'			=> 'Synchronizacja działu',
	'SYNC_IN_PROGRESS_EXPLAIN'	=> 'Aktualnie synchronizuję tematy %1$d/%2$d.',
