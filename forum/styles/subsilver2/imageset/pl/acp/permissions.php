...
*
* @package language
* @version $Id: permissions.php 9443.1 2009-05-30 Ronnie $
...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Żeby dowiedzieć się więcej o zarządzaniu uprawnieniami przeczytaj <a href="http://phpbb3.pl/support/documentation/quickstart/quick_permissions.html" rel="external">Rozdział 1.5 naszego przewodnika Szybki Start</a>.</p>
	',
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Tutaj możesz zarządzać globalnymi prawami administracyjnymi grup lub użytkowników. Wszyscy użytkownicy z uprawnieniami administracyjnymi mają dostęp do Panelu Administracyjnego.',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Ma możliwość korzystania ze wszystkich funkcji forum w danym dziale, w tym pisania ogłoszeń i przyklejania tematów. Może też ignorować limit wysłania jednej wiadomości w wybranym przez administratora czasie.<br />Niezalecane dla zwykłych użytkowników.',
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> 'Ma możliwość korzystania z części funkcji forum, ale nie może załączać plików i używać ikon postów/tematów.',
	...
	'ROLE_DESCRIPTION_FORUM_ONQUEUE'		=> 'Ma uprawnienia takie, jak przy standardowym dostępie, ale jego posty i tematy muszą być akceptowane przez moderatora.',
	...
	'ROLE_DESCRIPTION_FORUM_STANDARD'		=> 'Ma możliwość korzystania z większości funkcji forum (w tym wysyłania załączników i usuwania własnych tematów), ale nie może blokować własnych tematów ani tworzyć ankiet.',
	...
	'ROLE_DESCRIPTION_MOD_SIMPLE'			=> 'Ma możliwość wykonywania tylko podstawowych akcji związanych z tematami i postami. Nie może przyznawać ostrzeżeń ani używać kolejki moderacji.',
