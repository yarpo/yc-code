...
*
* @package language
* @version $Id: ucp.php 9378.2 2009-05-30 Ronnie
...
$lang = array_merge($lang, array(
	...
	<br/>
	Zgadzasz się nie pisać żadnych wypowiedzi o charakterze obraźliwym, oszczerczym, propagującym treści niezgodne z polskim prawem lub naruszających cudze prawa autorskie. Robienie tego może spowodować, że zostaniesz zbanowany na zawsze, a Twój dostawca internetu powiadomiony o Twoim zachowaniu. Zgadzasz się, że „%1$s” ma prawo w każdej chwili usunąć, przeedytować, przenieść lub zablokować każdy temat. Zgadzasz się też na zapisywanie wszystkich informacji, które podajesz, w bazie danych. Dane te nie będą przekazywane nikomu bez Twojej zgody, ale ani „%1$s” ani phpBB nie odpowiada za włamania, które mogą spowodować wykradzenie danych.
	',
...
$lang = array_merge($lang, array(
	...
	'BOOKMARKS'					=> 'Zakładki',
	'BOOKMARKS_EXPLAIN'			=> 'Możesz dodać tematy do zakładek, żeby później do nich wrócić. Zaznacz pole obok każdej zakładki, którą chcesz wyrzucić, a następnie naciśnij przycisk <em>Usuń wybrane zakładki</em>.',
	...
	'DEFAULT_SMILIES'			=> 'Domyślnie odblokuj emotikony',
	...
	'EMAIL_REMIND'				=> 'To musi być adres e-mail związany z Twoim kontem. Jeżeli nie zmieniałeś go w Panelu Zarządzania Kontem, jest to adres podany w czasie rejestracji.',
	...
	'LOGIN_EXPLAIN_UCP'			=> 'Zaloguj się, aby otrzymać dostęp do Panelu Zarządzania Kontem.',
	...
	'NO_WATCHED_SELECTED'		=> 'Nie wybrałeś(aś) żadnych obserwowanych tematów ani działów.',
	'NO_WATCHED_TOPICS'			=> 'Nie obserwujesz żadnych tematów.',
	...
	'RETURN_UCP'						=> '%sPowrót do Panelu Zarządzania Kontem%s',
	...
	'UCP_WELCOME'					=> 'Witamy w Panelu Zarządzania Kontem. Możesz stąd monitorować, przeglądać i edytować swój profil, ustawienia, obserwowane działy i tematy. Możesz też wysyłać wiadomości do innych użytkowników (jeśli administracja na to pozwala). Upewnij się, że przeczytałeś ogłoszenia, zanim będziesz kontynuował.',
	...
	'VIEW_TOPICS_DAYS'			=> 'Pokaż tematy z poprzednich dni',
	'VIEW_TOPICS_DIR'			=> 'Kierunek',
	'VIEW_TOPICS_KEY'			=> 'Pokaż tematy wg',
	'VIEW_POSTS_DAYS'			=> 'Pokaż posty z poprzednich dni',
	'VIEW_POSTS_DIR'			=> 'Kierunek',
	'VIEW_POSTS_KEY'			=> 'Pokaż posty wg',

	'WATCHED_EXPLAIN'			=> 'Poniżej znajduje się lista działów i tematów, które obserwujesz. Będziesz informowany o każdym nowym poście w nich napisanym. Aby przestać obserwować, zaznacz dział lub temat i naciśnij przycisk <em>Przestań obserwować wybrane</em>.',
