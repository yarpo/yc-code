...
*
* @package language
* @version $Id: help_faq.php 8896.7 2009-05-20 Ronnie $
...
$help = array(
	...
	array(
		0 => 'Do czego służy przycisk „Zapisz” w widoku tworzenia tematu?',
		1 => 'Ta opcja pozwala Ci zapisywać kopie robocze Twoich tematów, które mogą być dokończone i umieszczone na forum w przyszłości. By powrócić do kopii roboczej, odwiedź swój Panel Zarządzania Kontem.'
	),
	array(
	...
	array(
		0 => 'Jak mogę przesunąć swój temat w górę?',
		1 => 'Klikając w link „Przesuń temat w górę” w widoku tematu, możesz odkopać go na samą górę pierwszej strony działu. Jednakże, jeśli nie widzisz takiego linku, oznacza to, że funkcja ta mogła zostać wyłączona lub wymagany czas między dwoma użyciami tej opcji jeszcze nie minał. Innym sposobem na odkopanie tematu jest dopisanie w nim posta, trzymaj się jednak zasad robiąc to.'
	),
	array(
		0 => '--',
		1 => 'Formatowanie i rodzaje tematów'
	),
	array(
		0 => 'Czym jest BBCode?',
	...
	array(
		...
		1 => 'Listę wszystkich dodanych przez siebie załączników znajdziesz w panelu Twojego konta, przechodząc do sekcji załączników.'
	),
	array(
		0 => '--',
		1 => 'Sprawy phpBB3'
