...
*
* @package language
* @version $Id: posting.php 9464 2009-05-10 LEW21 $
...
$lang = array_merge($lang, array(
	...
	'ATTACH_SIG'				=> 'Dołącz podpis (można go zmienić w Panelu Zarządzania Kontem)',
	...
	'CANNOT_POST_STICKY'		=> 'Nie możesz przykleić tematu.',
	...
	'LOAD_DRAFT_EXPLAIN'		=> 'Tutaj możesz wybrać kopię roboczą do wczytania, aby kontynuować pisanie postu. Aktualny post zostanie anulowany, wszystko co z nim związane zostanie usunięte. Możesz przeglądać, edytować i usuwać kopie robocze z poziomu swojego Panelu Zarządzania Kontem.',
	'LOGIN_EXPLAIN_BUMP'		=> 'Musisz się zalogować, żeby przesuwać w górę tematy w tym dziale.',
	...
	'LOGIN_EXPLAIN_REPLY'		=> 'Musisz się zalogować, żeby odpowiadać w tematach w tym dziale.',
	...
	'MORE_SMILIES'				=> 'Pokaż więcej emotikon',
	...
	'POST_DELETED'				=> 'Wiadomość została usunięta.',
	'POST_EDITED'				=> 'Wiadomość została zmieniona.',
	'POST_EDITED_MOD'			=> 'Wiadomość została zmieniona, ale zanim zmiany zostaną wyświetlone, muszą one zostać zaakceptowane przez moderatora.',
	'POST_GLOBAL'				=> 'Globalny',
	'POST_ICON'					=> 'Ikonka',
	'POST_NORMAL'				=> 'Zwykły',
	'POST_REVIEW'				=> 'Przegląd',
	'POST_REVIEW_EXPLAIN'		=> 'Przynajmniej jeden post został dopisany w tym temacie. Jeśli chcesz, możesz poprawić swój post.',
	'POST_STORED'				=> 'Wiadomość została wysłana',
	'POST_STORED_MOD'			=> 'Wiadomość została wysłana, ale zanim zostanie wyświetlona, musi zostać zaakceptowana przez moderatora.',
	'POST_TOPIC_AS'				=> 'Napisz temat jako',
	...
	'SAVE_DRAFT_CONFIRM'		=> 'Kopie robocze zawierają tylko temat i treść wiadomości, a wszystkie inne elementy (np. załączniki i ankiety) zostaną usunięte. Czy chcesz zapisać kopię roboczą?',
	'SMILIES'					=> 'Emotikony',
	'SMILIES_ARE_OFF'			=> 'Emotikony są <em>wyłączone</em>',
	'SMILIES_ARE_ON'			=> 'Emotikony są <em>włączone</em>',
	'STICKY_ANNOUNCE_TIME_LIMIT'=> 'Limit czasu przylepienia',
	'STICK_TOPIC_FOR'			=> 'Przyklej temat na',
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Wpisz 0 lub pozostaw puste żeby przylepić na zawsze.',
	...
	'TOO_MANY_SMILIES'			=> 'Wiadomość zawiera za dużo emotikonów. Maksimum to %d.',
	...
	'UNGLOBALISE_EXPLAIN'		=> 'Aby zmienić status tematu z ogłoszenia globalnego na zwykły temat, musisz wybrać dział, w którym ma się on wyświetlać.',
	...
	'USER_CANNOT_BUMP'			=> 'Nie możesz przesuwać w górę tematów w tym dziale.',
	...
	'VIEW_MESSAGE'				=> '%sZobacz wysłaną wiadomość%s',
	'VIEW_PRIVATE_MESSAGE'		=> '%sZobacz wysłaną prywatną wiadomość%s',
