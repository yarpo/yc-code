...
*
* @package language
* @version $Id: help_bbcode.php 9461 2009-05-10 LEW21 $
...
$help = array(
	...
	array(
		...
		1 => 'Załączniki moga być wstawiane do postów za pomocą nowej pary znaczników BBcode - <code><strong>[attachment=]</strong></code> i <code><strong>[/attachment]</strong></code>. Aby ów znacznik działał, wysyłanie i pobieranie załączników musi zostać włączone w Panelu Administracyjnym, a Ty musisz posiadać odpowiednie uprawnienia. W formularzu wysyłania postu jest lista wyboru służąca do wstawiania załączników w treści postu.'
	),
	array(
		0 => '--',
		1 => 'Inne sprawy'
	...
	array(
		...
		1 => 'Jeżeli jesteś administratorem tego forum i masz odpowiednie uprawnienia, możesz dodawać nowe znaczniki BBCode przez Panel Administracyjny (ACP -> karta PISANIE -> grupa WIADOMOŚCI, link BBCode)'
	)
);
