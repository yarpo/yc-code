...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'LOCAL_URL'		=> 'Lokalny URL. Musi prowadzić od strony wyświetlającej temat i nie może zawierać nazwy serwera czy protokołu.',
...
// Uśmieszki i ikony
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'Tutaj możesz dodawać, usuwać i zmieniać ikony, które użytkownicy mogą ustawiać swoim tematom, postom i prywatnym wiadomościom. Ikony te zazwyczaj są wyświetlane w pobliżu tytułów tematów na liście tematów i w pobliżu tytułów postów na liście postów. Możesz też zainstalować lub utworzyć pakiet ikon.',
