...
*
* @package language
* @version $Id: board.php 9497.2 2009-05-30 Ronnie $
...
$lang = array_merge($lang, array(
	...
	'ALLOW_TOPIC_NOTIFY'		=> 'Włącz obserwowanie tematów',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUEUE_TRIGGER'			=> 'Umieszczaj posty nowych użytkowników w kolejce moderacji',
	'ENABLE_QUEUE_TRIGGER_EXPLAIN'	=> 'Powoduje umieszczanie postów zarejestrowanych użytkowników w kolejce moderacji gdy ich liczba postów jest niższa niż wartość podana niżej. Ustawienie to nie ma związku z uprawnieniem do pisania bez akceptacji.',
	'QUEUE_TRIGGER_POSTS'			=> 'Limit liczby postów nowych użytkowników',
	'QUEUE_TRIGGER_POSTS_EXPLAIN'	=> 'Jeśli umieszczanie postów nowych użytkowników w kolejce moderacji jest włączone, jest to liczba postów jaką użytkownik musi uzyskać żeby móc pisać bez akceptacji postów przez moderatorów. Jeśli użytkownik ma mniej postów, jego post trafi do kolejki.',

	'BUMP_INTERVAL'					=> 'Interwał przesuwania w górę',
	'BUMP_INTERVAL_EXPLAIN'			=> 'Liczba minut, godzin lub dni, między datą napisania ostatniego postu w temacie, a możliwością przesunięcia tematu w górę.',
	...
	'HOT_THRESHOLD'					=> 'Oznaczenie popularnych tematów',
	'HOT_THRESHOLD_EXPLAIN'			=> 'Liczba postów w temacie wymagana do oznaczenia go jako popularny. Ustaw na 0, aby zablokować popularne tematy.',
...
$lang = array_merge($lang, array(
	...
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> 'Pozwala użytkownikom żądać nowych kodów potwierdzających w przypadku braku możliwości zrozumienia obrazka wysłanego wcześniej.',
));
...
$lang = array_merge($lang, array(
	...
	'COOKIE_SECURE_EXPLAIN'		=> 'Jeśli Twój serwer korzysta z SSL, włącz tę opcję, <strong>jeśli nie - pozostaw ją wyłączoną</strong>. Włączenie jej i nie korzystanie z SSL spowoduje błędy serwera w czasie przekierowań.',
...
$lang = array_merge($lang, array(
	...
	'LOAD_CPF_VIEWTOPIC'			=> 'Wyświetl własne pola profilu w tematach',
	'LOAD_USER_ACTIVITY'			=> 'Wyświetlaj aktywność użytkownika',
	'LOAD_USER_ACTIVITY_EXPLAIN'	=> 'Wyświetla, w profilu i Panelu Zarządzania Kontem, informację o temacie/dziale, w którym użytkownik napisał najwięcej postów. Zalecane jest wyłączenie tej funkcji na forach mających ponad milion postów.',
	...
	'YES_ANON_READ_MARKING_EXPLAIN'	=> 'Zapisuje informację czy tematy są przeczytane, czy nie, przez gości. Jeśli wyłączone, tematy zawsze są wyświetlane jako nieprzeczytane.',
	...
	'YES_ONLINE_EXPLAIN'			=> 'Wyświetla listę przeglądających forum na stronie głównej oraz listę przeglądających dział na stronach działów i tematów.',
	...
	'YES_ONLINE_TRACK_EXPLAIN'		=> 'Wyświetla, w profilu i na stronie tematu, informację czy dany użytkownik przegląda teraz forum.',
	'YES_POST_MARKING'				=> 'Włącz oznaczanie tematów',
	'YES_POST_MARKING_EXPLAIN'		=> 'Informuje czy użytkownik pisał w danym temacie.',
	'YES_READ_MARKING'				=> 'Włącz zapisywanie informacji o (nie)przeczytaniu tematu po stronie serwera',
	'YES_READ_MARKING_EXPLAIN'		=> 'Zapisuje informację czy tematy są przeczytane, czy nie, w bazie danych forum zamiast w ciasteczku.',
));
