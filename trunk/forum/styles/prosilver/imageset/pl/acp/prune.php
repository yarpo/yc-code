...
*
* @package language
* @version $Id: prune.php 8479.1 2009-03-23 Ronnie $
...
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'Tutaj możesz szybko oczyścić wybrany(e) dział(y) ze starych tematów. Najpierw wybierz dział(y), który(e) chcesz oczyścić, a potem ustaw zasady, według których ma się odbyć oczyszczanie. Jeśli nie zdefiniujesz żadnych kryteriów (tj. zostawisz obydwa pola puste lub wpiszesz 0), wszystkie tematy zostaną usunięte. Standardowo forum nie usunie tematów z nadal otwartymi ankietami ani tematów przyklejonych i ogłoszeń.',
	...
	'PRUNE_FINISHED_POLLS_EXPLAIN'	=> 'Usuwa tematy z przeterminowanymi ankietami.',
	...
	'PRUNE_OLD_POLLS_EXPLAIN'		=> 'Usuwa tematy z ankietami, w których nie głosowano od ustalonej wyżej liczby dni.',
