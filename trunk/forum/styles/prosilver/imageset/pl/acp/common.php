...
*
* @package language
* @version $Id: common.php 9382.1 2009-05-30 Ronnie $
...
$lang = array_merge($lang, array(
	...
	'ADM_LOGOUT'			=> 'Wyloguj&nbsp;z&nbsp;ACP',
	'ADM_LOGGED_OUT'		=> 'Wylogowałeś/aś się z Panelu administracyjnego.',
	...
	'LOGIN_ADMIN_SUCCESS'	=> 'Ponowne uwierzytelnianie się udało, więc zaraz zostaniesz przekierowany do Panelu administracyjnego.',
	...
	'NO_PASSWORD_SUPPLIED'	=> 'Żeby uzyskać dostęp do Panelu Administracyjnego, musisz podać swoje hasło.',
...
$lang = array_merge($lang, array(
	...
	'ACP_MOD_LOGS_EXPLAIN'		=> 'Ta lista zawiera wszystkie akcje wykonane na działach, tematach, postach i użytkownikach przez moderatorów (w tym banowanie).' . $log_info,
	'ACP_USERS_LOGS_EXPLAIN'	=> 'Ta lista zawiera wszystkie akcje wykonane przez użytkowników lub na użytkownikach (m.in. raporty, ostrzeżenia, notatki o użytkownikach).' . $log_info,
...
$lang = array_merge($lang, array(
	...
	'PURGE_CACHE_CONFIRM'	=> 'Czy jesteś pewien, że chcesz wyczyścić cache?',
	...
	'RESYNC_POST_MARKING_CONFIRM'	=> 'Czy jesteś pewien, że chcesz zsynchronizować oznaczone tematy?',
	'RESYNC_POST_MARKING_EXPLAIN'	=> 'Odznacza wszystkie tematy, a potem poprawnie oznacza te, które były aktywne w ciągu ostatnich sześciu miesięcy.',
	'RESYNC_STATS'					=> 'Zsynchronizuj statystyki',
	'RESYNC_STATS_CONFIRM'			=> 'Czy jesteś pewien, że chcesz zsynchronizować statystyki?',
	'RESYNC_STATS_EXPLAIN'			=> 'Przelicza liczbę postów, tematów, użytkowników i plików.',
	'RUN'							=> 'Uruchom',

	'STATISTIC'					=> 'Statystyki',
	'STATISTIC_RESYNC_OPTIONS'	=> 'Zsynchronizuj lub zresetuj statystyki',

	'TOPICS_PER_DAY'	=> 'Tematy dziennie',
...
// Log Entries
$lang = array_merge($lang, array(
	'LOG_ACL_ADD_USER_GLOBAL_U_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia użytkowania użytkownika</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_U_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia użytkowania grupy</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_M_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia moderacyjne użytkownika</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_M_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia moderacyjne grupy</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_A_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia administracyjne użytkownika</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_A_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia administracyjne grupy</strong><br />» %s',

	'LOG_ACL_ADD_ADMIN_GLOBAL_A_'		=> '<strong>Dodano lub przeedytowano globalne uprawnienia administracyjne użytkowników lub grup</strong><br />» %s',
	'LOG_ACL_ADD_MOD_GLOBAL_M_'			=> '<strong>Dodano lub przeedytowano globalne uprawnienia moderacyjne użytkowników lub grup</strong><br />» %s',

	'LOG_ACL_ADD_USER_LOCAL_F_'			=> '<strong>Dodano lub przeedytowano lokalne uprawnienia dostępu do działów</strong><br />%1$s<br /><strong>następującemu użytkownikowi</strong><br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_F_'		=> '<strong>Dodano lub przeedytowano lokalne uprawnienia dostępu do działów</strong><br />%1$s<br /><strong>następującej grupie</strong><br />» %2$s',
	'LOG_ACL_ADD_USER_LOCAL_M_'			=> '<strong>Dodano lub przeedytowano lokalne uprawnienia moderacyjne</strong><br />%1$s<br /><strong>następującemu użytkownikowi</strong><br />» %2$s',
	'LOG_ACL_ADD_GROUP_LOCAL_M_'		=> '<strong>Dodano lub przeedytowano lokalne uprawnienia moderacyjne działów</strong><br />%1$s<br /><strong>następującej grupie</strong><br />» %2$s',

	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Dodano lub przeedytowano lokalne uprawnienia moderacyjne działów</strong><br />%1$s<br /><strong>następującym użytkownikom/grupom</strong><br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Dodano lub przeedytowano lokalne uprawnienia dostępu do działów</strong><br />%1$s<br /><strong>następującym użytkownikom/grupom</strong><br />» %2$s',
	...
	'LOG_ADMIN_AUTH_FAIL'		=> '<strong>Nieudana próba logowania do Panelu Administracyjnego</strong>',
	'LOG_ADMIN_AUTH_SUCCESS'	=> '<strong>Zalogowano do Panelu Administracyjnego</strong>',
	...
	'LOG_ATTACH_EXT_UPDATE'		=> '<strong>Przeedytowano rozszerzenie załączników</strong><br />» %s',
	'LOG_ATTACH_EXTGROUP_ADD'	=> '<strong>Dodano grupę rozszerzeń</strong><br />» %s',
	'LOG_ATTACH_EXTGROUP_EDIT'	=> '<strong>Przeedytowano grupę rozszerzeń</strong><br />» %s',
	...
	'LOG_BBCODE_EDIT'		=> '<strong>Przeedytowano BBCode</strong><br />» %s',
	...
	'LOG_BOT_UPDATED'	=> '<strong>Przeedytowano bota</strong><br />» %s',
	...
	'LOG_CONFIG_ATTACH'			=> '<strong>Przeedytowano ustawienia załączników</strong>',
	'LOG_CONFIG_AUTH'			=> '<strong>Przeedytowano ustawienia uwierzytelniania</strong>',
	'LOG_CONFIG_AVATAR'			=> '<strong>Przeedytowano ustawienia avatarów</strong>',
	'LOG_CONFIG_COOKIE'			=> '<strong>Przeedytowano ustawienia ciasteczek</strong>',
	'LOG_CONFIG_EMAIL'			=> '<strong>Przeedytowano ustawienia e-maili</strong>',
	'LOG_CONFIG_FEATURES'		=> '<strong>Przeedytowano możliwości forum</strong>',
	'LOG_CONFIG_LOAD'			=> '<strong>Przeedytowano ustawienia obciążenia serwera</strong>',
	'LOG_CONFIG_MESSAGE'		=> '<strong>Przeedytowano ustawienia prywatnych wiadomości</strong>',
	'LOG_CONFIG_POST'			=> '<strong>Przeedytowano ustawienia postów</strong>',
	'LOG_CONFIG_REGISTRATION'	=> '<strong>Przeedytowano ustawienia rejestracji</strong>',
	'LOG_CONFIG_SEARCH'			=> '<strong>Przeedytowano ustawienia wyszukiwarki</strong>',
	'LOG_CONFIG_SECURITY'		=> '<strong>Przeedytowano ustawienia bezpieczeństwa</strong>',
	'LOG_CONFIG_SERVER'			=> '<strong>Przeedytowano ustawienia serwera</strong>',
	'LOG_CONFIG_SETTINGS'		=> '<strong>Przeedytowano ustawienia forum</strong>',
	'LOG_CONFIG_SIGNATURE'		=> '<strong>Przeedytowano ustawienia podpisów</strong>',
	'LOG_CONFIG_VISUAL'			=> '<strong>Przeedytowano ustawienia potwierdzenia wizualnego</strong>',

	'LOG_APPROVE_TOPIC'			=> '<strong>Zaakceptowano temat</strong><br />» %s',
	'LOG_BUMP_TOPIC'			=> '<strong>Przesunięto temat w górę</strong><br />» %s',
	'LOG_DELETE_POST'			=> '<strong>Usunięto post</strong><br />» %s',
	...
	'LOG_MERGE'					=> '<strong>Przeniesiono posty</strong><br />» do tematu %s',
	...
	'LOG_POST_EDITED'			=> '<strong>Przeedytowano post „%1$s” napisany przez</strong><br />» %2$s',
	'LOG_REPORT_CLOSED'			=> '<strong>Zamknięto raport</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Usunięto raport</strong><br />» %s',
	...
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Odrzucono temat „%1$s” z powodu</strong><br />%2$s',
	'LOG_TOPIC_RESYNC'			=> '<strong>Zresynchronizowano liczniki tematów</strong><br />» %s',
	'LOG_TOPIC_TYPE_CHANGED'	=> '<strong>Zmieniono typ tematu</strong><br />» %s',
	'LOG_UNLOCK'				=> '<strong>Odblokowano temat</strong><br />» %s',
	...
	'LOG_FORUM_EDIT'						=> '<strong>Przeedytowano szczegóły działu</strong><br />» %s',
	...
	'LOG_GROUP_UPDATED'		=> '<strong>Przeedytowano szczegóły grupy</strong><br />» %s',
	...
	'LOG_USERS_ADDED'		=> '<strong>Przyjęto użytkowników do grupy</strong> %1$s<br />» %2$s',
	...
	'LOG_IMAGESET_EDIT_DETAILS'		=> '<strong>Przeedytowano szczegóły zestawu obrazków</strong><br />» %s',
	'LOG_IMAGESET_EDIT'				=> '<strong>Przeedytowano zestaw obrazków</strong><br />» %s',
	...
	'LOG_JAB_SETTINGS_CHANGED'	=> '<strong>Przeedytowano ustawienia Jabbera</strong>',
	...
	'LOG_LANGUAGE_PACK_UPDATED'		=> '<strong>Przeedytowano szczegóły pakietu językowego</strong><br />» %s',
	...
	'LOG_MODULE_EDIT'		=> '<strong>Przeedytowano moduł</strong><br />» %s',

	'LOG_A_ROLE_ADD'		=> '<strong>Dodano zestaw uprawnień administracyjnych</strong><br />» %s',
	'LOG_A_ROLE_EDIT'		=> '<strong>Przeedytowano zestaw uprawnień administracyjnych</strong><br />» %s',
	...
	'LOG_F_ROLE_EDIT'		=> '<strong>Przeedytowano zestaw uprawnień dostępu do działów</strong><br />» %s',
	...
	'LOG_M_ROLE_EDIT'		=> '<strong>Przeedytowano zestaw uprawnień moderacyjnych</strong><br />» %s',
	...
	'LOG_U_ROLE_EDIT'		=> '<strong>Przeedytowano zestaw uprawnień użytkowania</strong><br />» %s',
	...
	'LOG_PROFILE_FIELD_EDIT'		=> '<strong>Przeedytowano pole profilu</strong><br />» %s',
	...
	'LOG_RANK_UPDATED'		=> '<strong>Przeedytowano rangę</strong><br />» %s',

	'LOG_REASON_ADDED'		=> '<strong>Dodano powód raportowania/odrzucania</strong><br />» %s',
	'LOG_REASON_REMOVED'	=> '<strong>Usunięto powód raportowania/odrzucania</strong><br />» %s',
	'LOG_REASON_UPDATED'	=> '<strong>Przeedytowano powód raportowania/odrzucania</strong><br />» %s',
	...
	'LOG_RESYNC_POST_MARKING'	=> '<strong>Zsynchronizowano oznaczone tematy</strong>',
	...
	'LOG_STYLE_EDIT_DETAILS'	=> '<strong>Przeedytowano styl</strong><br />» %s',
	...
	'LOG_TEMPLATE_EDIT_DETAILS'		=> '<strong>Przeedytowano szczegóły zestawu szablonów</strong><br />» %s',
	...
	'LOG_THEME_EDIT_DETAILS'	=> '<strong>Przeedytowano szczegóły motywu</strong><br />» %s',
	...
	'LOG_USER_LOCK'				=> '<strong>Użytkownik zablokował własny temat</strong><br />» %s',
	...
	'LOG_USER_UNLOCK'			=> '<strong>Użytkownik odblokował własny temat</strong><br />» %s',
	...
	'LOG_WORD_EDIT'			=> '<strong>Przeedytowano cenzurowane słowo</strong><br />» %s',
));
