...
*
* @package language
* @version $Id: profile.php 9342 2009-05-10 LEW21 $
...
$lang = array_merge($lang, array(
	...
	'DISPLAY_AT_PROFILE'			=> 'Wyświetl w Panelu Zarządzania Kontem',
	'DISPLAY_AT_PROFILE_EXPLAIN'	=> 'Użytkownik może je zmienić w Panelu Zarządzania Kontem.',
	...
	'DISPLAY_PROFILE_FIELD_EXPLAIN'	=> 'Pole profilu będzie wyświetlane we wszystkich miejscach ustawionych w ustawieniach obciążenia. Ustawienie na „nie” ukryje to pole na stronach tematów, profili i listy użytkowników.',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'Ukrywa to pole przed wszystkimi użytkownikami z wyjątkiem danego użytkownika, administratorów i moderatorów. Jeśli opcja „Wyświetlaj w Panelu Zarządzania Kontem” jest wyłączona, to użytkownik nie może oglądać i zmieniać wartości tego pola, może ono być zmieniane tylko przez administratorów.',
