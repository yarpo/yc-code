...
*
* @package language
* @version $Id: install.php 9508.1 2009-05-30 Ronnie $
...
$lang = array_merge($lang, array(
	...
	'CONVERT_INTRO'				=> 'Witamy w Ujednoliconym Systemie Konwerującym phpBB', // Unified Convertor Framework
	...
	'INSTALL_CONGRATS_EXPLAIN'      => '<p>Właśnie zainstalowałeś skrypt phpBB %1$s. Teraz możesz zrobić dwie rzeczy:</p>
		<h2>Przekonwertować istniejące forum do phpBB3</h2>
		<p>Za pomocą Ujednoliconego Systemu Konwerującego phpBB możesz przekonwertować forum oparte o phpBB2 i inne skrypty do phpBB3. Jeżeli masz forum, które chcesz przekonwertować, <a href="%2$s">uruchom konwerter</a>.</p>
		...
		<p><strong>Powinieneś teraz skasować, przenieść lub zmienić nazwę folderu install/. Jeśli tego nie zrobisz to działał będzie tylko Panel Administracyjny.</strong></p>',
	...
	<ul>
		...
		<li>Firebird, w wersji wyższej lub równej 2.0</li>
	...
	'INST_ERR_DB_NO_FIREBIRD'		=> 'Wersja Firebird zainstalowana na tym serwerze jest za stara i musi zostać zaktualizowana do wersji 2.0 lub wyższej.',
	...
	'NO_LOCATION'				=> 'Nie można określić położenia. Jeśli wiesz czy i gdzie ImageMagick jest zainstalowany, to podaj ścieżkę do niego w panelu administracyjnym po zainstalowaniu phpBB.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'=> 'Indeks wyszukiwarki ze starego forum nie został przekonwertowany. Wyszukiwanie zawsze będzie zwracać pusty rezultat. Aby utworzyć nowy indeks wyszukiwarki, idź do Panelu Administracyjnego, wybierz kartę <span style="text-transform: uppercase;">Konserwacja</span>, a następnie kliknij na Indeks wyszukiwarki.',
	...
	'STAGE_ADVANCED_EXPLAIN'	=> 'Ustawienia na tej stronie należy zmienić tylko wtedy, gdy wiesz, że potrzebujesz czegoś innego od standardu. Jeśli nie jesteś pewien, to przejdź do następnej strony, ponieważ to wszystko można zmienić później korzystając z Panelu Administracyjnego.',
	...
	'SYNC_TOPICS'				=> 'Rozpoczynajnie synchronizacji tematów',
	'SYNC_TOPIC_ID'				=> 'Synchronizacja tematów o ID od %1$s do %2$s',
	...
	'UPDATE_TOPICS_POSTED'		=> 'Generowanie informacji o napisanych tematach',
	'UPDATE_TOPICS_POSTED_ERR'	=> 'Wystąpił błąd w czasie generowania informacji o napisanych tematach. Gdy skończysz konwersję, będziesz mógł zsynchronizować te informacje w Panelu Administracyjnym.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Wszystkie pliki są identyczne z plikami najnowszej wersji phpBB3. Teraz powinieneś <a href="../ucp.php?mode=login">zalogować się</a> i sprawdzić, czy wszystko działa poprawnie. Nie zapomnij usunąć, zmienić nazwę lub przesunąć katalog install/!',
...
<p>Ta metoda jest podobna do pierwszej, ale zamiast samodzielnie wgrywać pliki wystarczy, że podasz informacje dotyczące logowania do Twojego serwera FTP. Po zakończeniu wgrywania pliki zostaną porównane ponownie. Jeśli wszystko będzie zaktualizowane, zostaniesz przeniesiony do aktualizacji bazy danych.',
	...
	'VERSION_CHECK_EXPLAIN'		=> 'Sprawdzanie, czy wersja phpBB, którą używasz, jest aktualna.',
	'VERSION_NOT_UP_TO_DATE'	=> 'Twoja instalacja phpBB nie jest aktualna. Kontynuuj proces aktualizacji.',
	'VERSION_NOT_UP_TO_DATE_ACP'=> 'Twoja instalacja phpBB nie jest aktualna.<br />Poniżej znajduje się link do ogłoszenia o wydaniu najnowszej wersji oraz instrukcje jak dokonać aktualizacji.',
