...
class jc_com_marketplace extends JCommentsPlugin
{
	...
	{
		$db = & JCommentsFactory::getDBO();
		$db->setQuery( 'SELECT ad_headline FROM #__marketplace_ads WHERE id = ' . $id );
	...
	function getObjectLink($id)
	{
		...
		$link = sefRelToAbs( "index.php?option=com_marketplace&amp;page=show_ad&amp;adid=" . $id . "&amp;Itemid=" . $_Itemid );
		return $link;
	}
